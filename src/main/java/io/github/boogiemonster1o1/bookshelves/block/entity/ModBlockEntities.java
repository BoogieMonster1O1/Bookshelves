...
public final class ModBlockEntities {
    ...
    public static final ScreenHandlerType<BookshelfScreenHandler> BOOKSHELF_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(new Identifier("bookshelves", "bookshelf"), BookshelfScreenHandler::create);
